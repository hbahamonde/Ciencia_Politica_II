  ...
  \item {\color{ForestGreen}{\bf \underline{Introducci\'on}}}
	...
	\item {\color{ForestGreen}{\bf \underline{Formaci\'on y Capacidad del Estado: Guerra, \'Elites, Impuestos, Riqueza y Justicia}}}
		\begin{itemize}
			...
			\item[4.] {\bf Formaci\'on del Estado: Latinoam\'erica y Sudeste Asi\'atico}.
				\begin{itemize}
					...
					%\item[$\circ$] Luis Schenoni. 2020. \href{https://github.com/hbahamonde/Ciencia_Politica_II/raw/master/Readings/Schenoni.pdf}{``Bringing War Back in: Victory and State Formation in Latin America.''} \emph{American Journal of Political Science}: 1---17.\phantom{\textcite{Schenoni2020}} 
      ...
      %  \end{itemize}
		...
		\item[10.] {\bf ¿Podr\'ia no existir el Estado? Dificultades Geogr\'aficas y Disidencia en el Sudeste Asi\'atico y \'Africa.}
				\begin{itemize}
          \item[$\circ$] Jeffrey Herbst. 2015. \href{https://github.com/hbahamonde/Ciencia_Politica_II/raw/master/Readings/Herbst.pdf}{\emph{States and Power in Africa: Comparative Lessons in Authority and Control}}. Princeton University Press. Ch. 5 (``National Design and the Broadcasting of Power'').\phantom{\textcite{Herbst2015}}
...
\item[{\color{red}\Pointinghand}] Ensayo midterm. Entra todo lo visto y discutido hasta el momento.
	...
	\item {\color{ForestGreen}{\bf \underline{Desigualdad Econ\'omica: ¿Qu\'e Han Hecho o Podr\'ian Hacer los Estados?}}}
        ...
        \end{itemize}
          ...
          %\item[$\circ$] Theda Skocpol. 1995.\href{https://github.com/hbahamonde/Ciencia_Politica_II/raw/master/Readings/Skocpol_1995.pdf}{``Protecting Soldiers and Mothers: The Political Origins of Social Policy in United States''} Harvard University Press. Ch.: ???.\phantom{\textcite{Alesina2001}}
