...
\begin{enumerate}[label=\roman*.]
  ...
  \item {\color{ForestGreen}{\bf \underline{Introducci\'on}}}
	...
	\item {\color{ForestGreen}{\bf \underline{Formaci\'on y Capacidad del Estado: Guerra, \'Elites, Impuestos, Riqueza y Justicia}}}
		...
		\item[7.] {\bf Independencia e Instituciones de ``State-building'' Post-Coloniales}.
				\begin{itemize}
			...
			\item[8.] {\bf Capacidad Estatal}.
				\begin{itemize}
					\item[$\circ$] Michael Mann. 2008. \href{https://github.com/hbahamonde/Ciencia_Politica_II/raw/master/Readings/Mann_2008.pdf}{``Infrastructural Power Revisited.''} \emph{Studies in Comparative International Development}, 43(3-4): 355---365.\phantom{\textcite{Mann2008a}} 
