  ...
  \item {\color{ForestGreen}{\bf \underline{Introducci\'on}}}
	...
	\item {\color{ForestGreen}{\bf \underline{Formaci\'on y Capacidad del Estado: Guerra, \'Elites, Impuestos, Riqueza y Justicia}}}
		...
		\item[7.] {\bf Independencia e Instituciones Post-Coloniales de ``State-building''}.
				\begin{itemize}
					\item[$\circ$]  Marcus Kurtz. 2013. \href{https://github.com/hbahamonde/Ciencia_Politica_II/raw/master/Readings/Kurtz_2013.pdf}{\emph{Latin American State-Building in Comparative Perspective: Social Foundations of Institutional Order}}. Cambridge University Press. Ch. 2.\phantom{\textcite{Kurtz2013}}
...
\item[{\color{red}\Pointinghand}] Ensayo midterm. Entra todo lo visto y discutido hasta el momento. Una semana de plazo.
	...
	\item {\color{ForestGreen}{\bf \underline{Desigualdad Econ\'omica: ¿Qu\'e Han Hecho o Podr\'ian Hacer los Estados?}}}
        ...
        \end{itemize}
          ...
          \item[$\circ$] Theda Skocpol. 1995.\href{https://github.com/hbahamonde/Ciencia_Politica_II/raw/master/Readings/Skocpol_1995.pdf}{``Protecting Soldiers and Mothers: The Political Origins of Social Policy in United States''} Harvard University Press: Introduction, Understanding the Origins of Modern Social Provision in the United States.\phantom{\textcite{Skocpol1995}}
